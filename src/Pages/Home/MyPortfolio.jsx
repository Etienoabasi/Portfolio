  ...
  return (
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        ...
        <div>
          <a href="https://github.com/Etienoabasi" className="btn btn-github" target="_blank" rel="noopener noreferrer">
            <svg
          ...
          <div key={index} className="portfolio--section--card">
            ...
            <div className="portfolio--section--card--content">
              <div>
               ...
               <a href={item.link} className="text-sm portfolio--link" target="_blank" rel="noopener noreferer"> 
                {item.linkText}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
